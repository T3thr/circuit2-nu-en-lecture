...
iG3=G3*Va; iG4=G4*Vb; iE2=iG2-iG4;
Qg=[-1 1 1 0; 0 -1 0 1];
Yb=diag([G1 G2 G3 G4]); M=Qg*Yb*Qg.';
fprintf('Va = %.12f V\nVb = %.12f V\n',Va,Vb);
fprintf('iG1=%.12f, iG2=%.12f, iG3=%.12f, iG4=%.12f, iE2=%.12f A\n',iG1,iG2,iG3,iG4,iE2);
fprintf('KCL-a residual = %.3e\n',iG1-iG3-iG2);
fprintf('KCL-b residual = %.3e\n',iG2-iG4-iE2);
disp('Qg*Yb*Qg^T ='); disp(M);
assert(abs(iG1-iG3-iG2)<1e-10 && abs(iG2-iG4-iE2)<1e-10);
% หมายเหตุ: RHS เป็น +G2*E3 เพราะ iG2=G2(Va-E3-Vb)
